...
- [Windows support via TCP fallback for qauld-ctl Unix Socket](https://github.com/qaul/qaul.net/pull/819) on [qaul/qaul.net](https://github.com/qaul/qaul.net) (2 days ago)
