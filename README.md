...
- [Windows support via TCP fallback for qauld-ctl Unix Socket](https://github.com/qaul/qaul.net/pull/819) on [qaul/qaul.net](https://github.com/qaul/qaul.net) (5 days ago)
- [Add qauld-ctl CLI and Unix socket control interface for qauld (#541)](https://github.com/qaul/qaul.net/pull/783) on [qaul/qaul.net](https://github.com/qaul/qaul.net) (3 weeks ago)
...
- [Lilit0x/shamela-extractor](https://github.com/Lilit0x/shamela-extractor) - A quick tool to search and extract books from Maktabah Shamela&#39;s library dump (2 days ago)
- [qaul/qaul.net](https://github.com/qaul/qaul.net) - Internet Independent Wireless Mesh Communication App (5 days ago)
