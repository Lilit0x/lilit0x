...
- [qaul Testing Framework](https://github.com/qaul/qaul.net/pull/837) on [qaul/qaul.net](https://github.com/qaul/qaul.net) (3 weeks ago)
- [Windows support via TCP fallback for qauld-ctl Unix Socket](https://github.com/qaul/qaul.net/pull/819) on [qaul/qaul.net](https://github.com/qaul/qaul.net) (1 month ago)
...
- [Lilit0x/jawhar](https://github.com/Lilit0x/jawhar) - A quick tool to search and extract books from Maktabah Shamela&#39;s library dump (2 weeks ago)
- [qaul/qaul.net](https://github.com/qaul/qaul.net) - Internet Independent Wireless Mesh Communication App (4 weeks ago)
...
- [sunng87/pgwire](https://github.com/sunng87/pgwire) - PostgreSQL wire protocol implemented as a rust library. (4 months ago)
